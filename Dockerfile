...
# Build the Vite frontend (outputs to dist/). The upstream
# build:crawlable-corpus / build:sitemap scripts are not part of the
# de-clouded fork's package.json, so they are omitted here.
