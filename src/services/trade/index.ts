...
const emptyTariffs: GetTariffTrendsResponse = { datapoints: [], fetchedAt: '', upstreamUnavailable: false, unavailableReason: 'TARIFF_TREND_UNAVAILABLE_REASON_UNSPECIFIED', coverageStartYear: 0, coverageEndYear: 0 };
const emptyFlows: GetTradeFlowsResponse = { flows: [], fetchedAt: '', upstreamUnavailable: false, unavailableReason: 'TRADE_FLOW_UNAVAILABLE_REASON_UNSPECIFIED', coverageStartYear: 0, coverageEndYear: 0 };
